...
(function( $ ) {
  $(function() {
  	...
  	function mtsInitGallSliders() {
  		if ( $('.full-slider-container').length ) {
    ...
    function mtsAddClassCurrent( el, index ) {
        el
                .find(".owl-item")
                .removeClass("current")
    ...
    function mtsSyncPosition( el, index ) {

        //PART 1 (adds 'current' class to thumbnail)
        mtsAddClassCurrent( el, index );


        //PART 2 (counts position)

        var itemsNo = el.find(".owl-item").length; //total items
        var visibleItemsNo = el.find(".owl-item.active").length; //visible items
        ...
        var visibleCurrentIndex = el.find(".owl-item.active").index( el.find(".owl-item.current") );
